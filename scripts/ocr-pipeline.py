...
INDEX = r"D:\ProjectManagement\Claude\wiki\考编\_索引\index.json"
OUTDIR = r"D:\ProjectManagement\Claude\wiki\考编\_extracted\_ocr_pages"

# G: drive may be unavailable; fall back to D: paths
import sys
if not os.path.exists(INDEX):
    INDEX = r"D:\ProjectManagement\ClaudeData\考编\_索引\index.json"
if not os.path.exists(os.path.dirname(OUTDIR)):
    OUTDIR = r"D:\ProjectManagement\ClaudeData\考编\_extracted\_ocr_pages"

# Source PDF base path (update if Quark drive letter changes)
PDF_BASE = r"G:\quark\Obsidian笔记\Clippings"
