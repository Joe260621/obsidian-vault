...
const OCR_PAGES_DIR = process.argv[2] || 'D:/ProjectManagement/Claude/wiki/考编/_extracted/_ocr_pages';
const OUT_DIR = process.argv[3] || 'D:/ProjectManagement/Claude/wiki/考编/_extracted/_ocr_results';
